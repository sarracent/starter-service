package com.claro.amx.sp.starterrestservice.commons.aop;

import com.claro.amx.sp.starterrestservice.annotations.auditable.AuditableApi;
import com.claro.amx.sp.starterrestservice.annotations.log.LogException;
import com.claro.amx.sp.starterrestservice.annotations.log.LogIgnore;
import com.claro.amx.sp.starterrestservice.commons.resolver.CustomHeadersResolver;
...
import com.claro.amx.sp.starterrestservice.utility.LogUtil;
import com.claro.amx.sp.starterrestservice.utility.Logs;
...
import static com.claro.amx.sp.starterrestservice.utility.Logs.Basic.*;
import static com.claro.amx.sp.starterrestservice.utility.Logs.Extras.ERROR_EXECUTE;
import static com.claro.amx.sp.starterrestservice.utility.Logs.Extras.START_TIME;
import static com.claro.amx.sp.starterrestservice.utility.Logs.Header.*;
...
public class LogAspect {
    ...
    @Around("@annotation(com.claro.amx.sp.starterrestservice.annotations.auditable.AuditableApi)")
    ...
    @Around("@annotation(com.claro.amx.sp.starterrestservice.annotations.log.LogDAO) || @annotation(com.claro.amx.sp.starterrestservice.annotations.log.LogBO)")
    ...
    @Pointcut("within(com.claro.amx.sp.starterrestservice..*)")
