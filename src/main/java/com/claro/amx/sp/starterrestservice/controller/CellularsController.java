...
@Tag(name = "Cellulars Controller", description = "The Cellulars Api")
@Validated
@RequestMapping(path = "/cellulars", produces = {APPLICATION_JSON_VALUE})
public interface CellularsController {


    @GetMapping(produces = {APPLICATION_JSON_VALUE})
    @Operation(summary = "Get Cellular Info by cellular number", description = "Returns cellular information")
    @Parameters(value = {
    ...
    ResponseEntity<CellularsResponse> getCellular(
